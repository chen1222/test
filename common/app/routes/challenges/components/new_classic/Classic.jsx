  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <SidePanel
            resetChallenge={this.openResetModal}
        ...
        >
          ...
          <Editor
            content={this.state.taskEditorHTML}
          ...
          <Editor
            content={this.state.practiceEditorHTML}
            executeChallenge={executeChallenge}
            id='code_editor'
            isSource={false}
            mode={mode}
            onChange={this.handlePracticeEditorChange}
            ref={(input) => { this.practiceEditorRef = input; }}
          />
        </Col>
        {this.renderPreview(showPreview)}
        <ResetModal
          close={this.closeResetModal}
          confirm={this.resetChallenge}
          open={this.state.openResetModal}
        />
        <ClassicModal
          close={this.closeSuccessModal}
          confirm={this.closeSuccessModal}
